...
# MODEL PARAMETERS
parser.add_argument("--bboxes", default=2, type=int, help="number of bounding boxes per patch")
parser.add_argument("--patches", default=7, type=int, help="number of patchesper patch")
parser.add_argument("--backbone", default="Darknet", type=str, help="Type of backbone to use during detectin")

# IMAGE PARAMETERS
parser.add_argument("--resize", default=448, type=int, help="Resize image pixels (e.g., 256x256)")
parser.add_argument("--crop", default=448, type=int, help="Random crop image pixels")
